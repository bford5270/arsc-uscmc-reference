...
The audience is medical unit personnel. Joint and tri-service use is welcomed but additive — the content is framed in USMC terms first.

## Authorship

Authored and maintained by medical unit personnel. Contributions are credited per page where they apply.

## Disclaimer

This site is a community professional reference compiled from publicly released doctrine. **It is not an official publication** of the Department of Defense, the Department of the Navy, the United States Marine Corps, or the Joint Trauma System. It carries no DoD endorsement. Always defer to current official doctrine and command policy. Where this site and current doctrine disagree, current doctrine prevails.
