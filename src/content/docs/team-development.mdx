...
- [MCRP 3-40A.7](https://www.marines.mil/portals/1/Publications/MCRP%203-40A.7%20formerly%20MCRP%204-11.1G.pdf) (formerly MCRP 4-11.1G, Jul 2013), *Health Service Support Tactics, Techniques, and Procedures* {/* TBD: confirm current edition */}
...
**Presentations:**
- [Ethics of Operational Medicine](https://gamma.app/docs/Ethics-of-Operational-Medicine-q2fdbxtybptm6ei)

> ⚠️ **Gap**: Crew Resource Management in surgical teams — no public Deployed Medicine module found. FRAME CPG is the primary CRM-adjacent resource for this audience.
