...
**Blood management.** Cold-stored low-titer O whole blood (LTOWB), component therapy where available, and a Walking Blood Bank (WBB) capability for surge or sustainment. WBB requires pre-screening, donor roster, and rapid activation procedures. See [JTS CPG: Walking Blood Bank](https://jts.health.mil/index.cfm/CPGs/cpgs).
