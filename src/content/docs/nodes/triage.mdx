...
- [Deployed Medicine — TCCC](https://www.deployedmedicine.com/tccc)
...
**Presentations:**
- [MASCAL Triage Principles: START and SALT](https://gamma.app/docs/MASCAL-Triage-Principles-START-and-SALT-x5mpfowjo3m0gi3) — primary unit deck
...
**SOPs:** [MASCAL SOP](/standards/sops/mascal/) · [Triage Officer SOP](/standards/sops/triage-officer/)

> ⚠️ **Gap**: No Deployed Medicine module found specific to MASCAL triage officer decision-making or MEDROE. JTS TCCC guidelines are the primary reference.
